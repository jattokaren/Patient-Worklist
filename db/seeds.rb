...
csv_text = File.read(Rails.root.join('lib', 'seeds', 'encounters_seed3.csv'))
csv = CSV.parse(csv_text, :headers => true, :encoding => 'ISO-8859-1')
csv.each do |row|
  t = Encounter.new    
  #t.id = row['id']      #This Primary Key gets automatically created
  ...
  #t.created_at = row['created_at']    #This timestamp gets automatically created
  #t.updated_at = row['updated_at'].   #This timestamp gets automatically created
  t.save
